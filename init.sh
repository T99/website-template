...
# Print start message.
	echo "Running website-template initialization script..."

# Prompt for relevant website information to find-and-replace template placeholder strings.
	read -p "  Website name: "			  packageName
	read -p "  Website description: "	packageDesc
...
# Modify template files to use correct package information.
	echo -n "  Modifying template files to use correct website information... "
